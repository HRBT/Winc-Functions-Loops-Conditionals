...
def farm_action(Weather, Time_of_day, Cow_milking_status, Location_of_the_cows, Season, Slurry_tank, Grass_status):
    ...
    elif Location_of_the_cows == 'pasture' and Slurry_tank == True and Weather != 'sunny':
        return('take cows to cowshed \nfertilize pasture')
    if Location_of_the_cows == 'cowshed' and Slurry_tank == True and Weather != 'windy':
        return('fertilize pasture')
    elif Location_of_the_cows == 'pasture' and Slurry_tank == True and Weather != 'windy':
        return('take cows to cowshed \nfertilize pasture')
    if Location_of_the_cows == 'cowshed' and Grass_status == True and Season == 'spring' and Weather == 'sunny':
        return('mow grass') 
    elif Location_of_the_cows == 'pasture' and Grass_status == True and Season == 'spring' and Weather == 'sunny':
        return('take cows to cowshed \nmow grass \ntake cows back to pasture')
